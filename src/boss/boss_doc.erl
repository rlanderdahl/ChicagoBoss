...
get_vars("api-view.html", _InDir) ->
    {erlydtl_filters, EDoc} = edoc:get_doc("./_build/default/lib/erlydtl/src/erlydtl_filters.erl", []),
...
get_vars("api-db.html", _InDir) ->
    {boss_db, EDoc} = edoc:get_doc("./_build/default/lib/boss_db/src/boss_db.erl", []),
    [{functions, extract_function_docs(EDoc)}];
get_vars("api-mq.html", _InDir) ->
    {boss_mq, EDoc} = edoc:get_doc("src/boss/boss_mq.erl", []),
    [{functions, extract_function_docs(EDoc)}];
get_vars("api-news.html", _InDir) ->
    {boss_news, EDoc} = edoc:get_doc("./_build/default/lib/boss_db/src/boss_news.erl", []),
    [{functions, extract_function_docs(EDoc)}];
